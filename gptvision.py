...
def scan_invoice_with_gpt(invoice: bytes) -> dict:
    ...
    prompt = ("Extract the data from this invoice and return it as json. If a value is not present, provide null. Do not format the response with markdown. Use the following structure: " + json.dumps(prompt_structure))
